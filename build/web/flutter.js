...
Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`),
                ...
                let s = navigator.serviceWorker.register(o).then(c => this._getNewServiceWorker(c, r)).then(this._waitForServiceWorkerActivation);
        ...
        class f {
            ...
            async loadEntrypoint(e) {
                let { entrypointUrl: r = `${l}main.dart.js`, onEntrypointLoaded: t, nonce: i } = e || {};
            ...
            _createScriptTag(e, r) {
                ...
                t.type = "application/javascript",
                    r && (t.nonce = r);
                let i = e;
                return this._ttPolicy != null && (i = this._ttPolicy.createScriptURL(e)),
                    t.src = i,
                    t
            }
        }
        class v {
            async loadEntrypoint(e) {
                ...
                let s = new f;
                return s.setTrustedTypesPolicy(i.policy),
